const QuestionData = [
  ...
  {
    question:
      '1.คุณและเพื่อนเป็นพนักงานในบริษัทแห่งหนึ่งที่มีความสนิทสนมกันมาก และทำผลงานได้ดีอย่างต่อเนื่องมาโดยตลอด อีกทั้งยังเป็นตัวหลักในการสร้างกำไรให้กับองค์กรอย่างมาก วันหนึ่งคุณพบว่าเพื่อนของคุณทุจริตต่อบริษัท  แต่เป็นการทุจริตที่ไม่ส่งผลกระทบต่อองค์กรมากนัก คุณคิดว่าสิ่งใดที่คุณไม่ควรทำ (ต้องตอบทุกข้อ อย่างน้อย 1 ข้อ)',
    choices: [
