    ...
    <div className="flex flex-col items-center justify-center ">
      ...
      >
        ...
        <ul className="text-left px-8 list-disc">
          <li className="py-2">
            คุณมีเวลาทั้งหมด 20 วินาที ในการตอบคำถามแต่ละข้อ
          </li>
          <li className="py-2">
            กดปุ่ม แสดงตัวเลือก เพื่อแสดงตัวเลือกของแต่ละคำถาม
            โดยที่จะเริ่มจับเวลาเมื่อกดปุ่ม{' '}
          </li>
          แสดงตัวเลือก
          <li className="py-2">เมื่อกดปุ่ม ข้อถัดไป เพื่อไปสู่คำถามข้อถัดไป</li>
          <li className="py-2">
          ...
          <li className="py-2">
            กดปุ่ม เริ่มทำแบบประเมิน เพื่อเริ่มการทำแบบประเมินในพาร์ทที่ 1.1
          </li>
        </ul>
      </div>
    </div>
