  ...
  return (
    <div className="flex flex-col items-center justify-center ">
      <div
        ...
        id="introduction1"
      >
        <p className="px-4 py-4 text-base sm:text-sm lg:text-xl">
          แบบประเมินชุดนี้ประกอบไปด้วยข้อคำถามทั้งหมด 2 พาร์ทหลัก ได้แก่
        </p>
        <ul className="text-left px-4 text-base sm:text-sm lg:text-xl">
          <li className="py-2">
            ข้อคำถามเพื่อวัด{' '}
        ...
        <p className="px-4 py-2 text-base sm:text-sm lg:text-xl">
